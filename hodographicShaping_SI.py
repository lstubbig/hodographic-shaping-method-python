...
class hodographicShaping(object):
    ...
    def shapingRadial(self):
        ...
        self.r = lambda t: (self.rDepCyl[0] + self.cRadial[0] * rFunc.Iv1(t)
                            ...
                            + rFuncFree.Iv(t) - (self.cRadial[0] * rFunc.Iv1(0)
                            			+ self.cRadial[1] * rFunc.Iv2(0)
                            			+ self.cRadial[2] * rFunc.Iv3(0)
                            			+ rFuncFree.Iv(0)))
    ...
    def shapingVertical(self):
        ...
        self.z = lambda t: (self.rDepCyl[2] + self.cVertical[0] * zFunc.Iv1(t)
                        ...
                        + zFuncFree.Iv(t) - (self.cVertical[0] * zFunc.Iv1(0)
                        		    + self.cVertical[1] * zFunc.Iv2(0)
                        		    + self.cVertical[2] * zFunc.Iv3(0)
                        		    + zFuncFree.Iv(0)))
